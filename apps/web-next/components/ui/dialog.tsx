...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-x-4 top-[15%] z-50 grid gap-4 rounded-2xl border bg-background p-6 shadow-lg outline-none sm:inset-x-auto sm:top-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-lg',
